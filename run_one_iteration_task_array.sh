...
#SBATCH --output=/scratch/fsamir8/augmentation_subset_select/augmentation_everything_task_array_%a.out
#SBATCH --error=/scratch/fsamir8/augmentation_subset_select/augmentation_everything_task_array_%a.error
