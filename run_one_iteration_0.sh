...
#SBATCH --output=/scratch/fsamir8/augmentation_subset_select/augmentation_everything_0.out
#SBATCH --error=/scratch/fsamir8/augmentation_subset_select/augmentation_everything_0.error
